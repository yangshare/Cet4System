...
import com.cet4system.domain.Teacher;
...
public class TeacherAction {
	...
	public String tleft(){
		...
		teachers = objectService.check("教师", username, password);
		return "tleft";
	}
	public int getMaxPage() {
		int maxRow = objectService.getObject("Teacher").size();
	...
	public String update(){
		...
		//只有图片改变的时候才重新上传
		if(tImage.equals(teacher.getTeacherImage())){
			teacherImage = tImage;
		} else {
		...
		teacher.setTeacherOfSchool(teacherOfSchool);

...
public class ExamineeAction {
	...
	public String update() {
		...
		double writingGrade = Double.parseDouble(request
				.getParameter("writingGrade"));
		double listeningGrade = Double.parseDouble(request
				.getParameter("listeningGrade"));
		double readingGrade = Double.parseDouble(request
				.getParameter("readingGrade"));
		double comprehensivingGrade = Double.parseDouble(request
				.getParameter("comprehensivingGrade"));
		...
		examinee.setCandidateNo(candidateNo);
		examinee.setName(name);
		examinee.setSex(sex);
		examinee.setExamineeOfSchool(examineeOfSchool);
		examinee.setImage(examineeImage);
		examinee.setWritingGrade(writingGrade);
		examinee.setListeningGrade(listeningGrade);
		examinee.setReadingGrade(readingGrade);
		examinee.setComprehensivingGrade(comprehensivingGrade);
		examinee.setTotal(total);
